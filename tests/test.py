...
class ActualConfig:
    ...
    def test_watchers(self):
        ...
        self.search_and_set_watcher('update_delay_in_seconds', 2)
        self.search_and_set_watcher('copy_or_unrar', 'unrar')
        self.search_and_set_watcher('remove_after_finished', 0)
        self.search_and_set_watcher('unrar_match_only_rar_extension', 1)
        self.search_and_set_watcher('unrar_not_rar_but_match_regexp', '')
